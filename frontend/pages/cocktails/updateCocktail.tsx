...
import UpdateCocktailForm from "@/components/cocktail/CocktailUpdateForm";
                    ...
                    <div className={[styles.first,"row"].join(' ')}>
                        <div className={[styles.second,"col-lg-11 order-2 m-auto"].join(' ')}>
                            <div className={styles.third}>
                                <h1 className={styles.h1style}>Update Cocktail</h1>
                                <div className={styles.fourth}>
                                    <div className={styles.fifth}>
                                        <div>
                                         <UpdateCocktailForm></UpdateCocktailForm>
                                        </div>
                                    </div>
                                    </div>
                                </div>
